...
class AdminMockData {
  ...
  static const adOfferRows = <AdOfferRow>[
    ...
    AdOfferRow(
      ...
      advertiser: 'Naivas',
      accentHex: '#1B8A4A',
      productName: 'Jamii Pure Mwea Pishori Rice 5Kg',
      oldPriceCents: 145000,
      newPriceCents: 99900,
      currency: 'KES',
      placement: 'home',
      category: 'Dry Foods & Cereals',
    ...
    AdOfferRow(
      ...
      advertiser: 'Naivas',
      accentHex: '#1B8A4A',
      productName: 'Highlands Lemon Drink 2L',
      oldPriceCents: 34900,
      newPriceCents: 24900,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Naivas',
      accentHex: '#1B8A4A',
      productName: 'Rina Vegetable Oil 5 Ltr',
    ...
    AdOfferRow(
      ...
      accentHex: '#E2001A',
      productName: 'Velvex Hand Wash Floral 400ML',
      oldPriceCents: 22000,
      newPriceCents: 13200,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Carrefour',
      accentHex: '#E2001A',
      productName: 'Persil Hand Wash Powder Rose 500G',
      oldPriceCents: 25500,
      newPriceCents: 15300,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Carrefour',
      accentHex: '#E2001A',
      productName: 'Ariel Liquid Auto Wash Original 3L',
      oldPriceCents: 219900,
      newPriceCents: 148500,
      currency: 'KES',
      placement: 'home',
      category: 'Laundry & Cleaning',
      displayOrder: 7,
    ...
    AdOfferRow(
      ...
      advertiser: 'Carrefour',
      accentHex: '#E2001A',
      productName: 'Daima Butter Salted 500G',
      oldPriceCents: 77000,
      newPriceCents: 57500,
      currency: 'KES',
      placement: 'home',
