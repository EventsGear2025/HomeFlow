...
class AdminMockData {
  static const navItems = <AdminNavItem>[
    ...
    AdminNavItem(label: 'Ads', icon: Icons.campaign_outlined),
  ...
  static const adOfferRows = <AdOfferRow>[
    AdOfferRow(
      id: 'ad000000-0000-0000-0000-000000000001',
      advertiser: 'Naivas',
      accentHex: '#1B8A4A',
      productName: 'Naivas Fino UHT Milk 500ML',
      oldPriceCents: 5200,
      newPriceCents: 4900,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Naivas',
      accentHex: '#1B8A4A',
      productName: 'Celine Petals Tissue 10 Pack',
      oldPriceCents: 44500,
      newPriceCents: 22500,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Naivas',
      accentHex: '#1B8A4A',
      productName: 'Celine Serviettes 100 Sheets',
      oldPriceCents: 14000,
      newPriceCents: 9900,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Naivas',
      accentHex: '#1B8A4A',
      productName: 'Sunrice Basmati Rice 5Kg',
      oldPriceCents: 182500,
      newPriceCents: 129900,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Naivas',
      accentHex: '#1B8A4A',
      productName: 'Rina Vegetable Oil 5L',
      oldPriceCents: 160000,
      newPriceCents: 139900,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      accentHex: '#E2001A',
      productName: 'Fresh Chicken Drumsticks (per kg)',
      oldPriceCents: 87900,
      newPriceCents: 64900,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Carrefour',
      accentHex: '#E2001A',
      productName: 'Softleaf Virgin Toilet Paper Unwrap x10',
      oldPriceCents: 55700,
      newPriceCents: 38900,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Carrefour',
      accentHex: '#E2001A',
      productName: 'Velvex Toilet Rolls White x10',
      oldPriceCents: 57700,
      newPriceCents: 40300,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Carrefour',
      accentHex: '#E2001A',
      productName: 'Clorox Lemon Liquid 750ML',
      oldPriceCents: 41500,
      newPriceCents: 29000,
      currency: 'KES',
      placement: 'home',
    ...
    AdOfferRow(
      ...
      advertiser: 'Carrefour',
      accentHex: '#E2001A',
      productName: 'Huggies Dry Comfort Diapers Jumbo',
      oldPriceCents: 208900,
      newPriceCents: 146200,
      currency: 'KES',
      placement: 'home',
      category: 'Baby & Kids',
      displayOrder: 10,
